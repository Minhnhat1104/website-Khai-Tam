...
contentInner.innerHTML = `
    ...
    <h2 class="post__title">${educationPosts[1].postTitle}</h2>
    <p class="post__text">
        ${educationPosts[1].postText}
    </p>
    <img src="${educationPosts[1].postImg}" alt="postImg" class="post__img">
    <p class="post__text">
    ${postAfterText}
    </p>
    <p class="post__source">${educationPosts[1].postSource}</p>
    </div>
`;
