...
<body>
    <div id="main">
        ...
        <div class="content__wrapper">
            <div class="slider">
                <ul class="slider-imgs__list">
                    <!-- add 'active' class to display -->
                    <li class="slider-img__item active">
                        <img src="../assets/images/Slider/1.png" alt="sliderImg" class="slider__img">
                    </li>
                    <li class="slider-img__item">
                        <img src="../assets/images/Slider/2.png" alt="sliderImg" class="slider__img">
                    </li>
                    <li class="slider-img__item">
                        <img src="../assets/images/Slider/3.png" alt="sliderImg" class="slider__img">
                    </li>
                </ul>

                <i class="arrow-left__icon fas fa-angle-left"></i>
                <i class="arrow-right__icon  fas fa-angle-right"></i>

                <ul class="indexs__list">
                    <!-- them active vao li -->
                            ...
                            <div class="exper__item__inner">
                                <div class="icon-and-text">
                                    ...
                                    <span class="exper__text">
                                        Nghe những lời như thế này nhiều lần tạo cho tớ một thói quen "rào trước" mỗi
                                        khi kể chuyện, kiểu "Ừ chuyện này cũng không khổ gì lắm nhưng do t nhạy cảm nên
                                        t thấy abc...". Cho tới một lần nọ, một người anh đã phản hồi tớ ngay lại rằng:
                                        "Nếu em không thấy rằng em may mắn, em có thể nói như vậy, điều đó cũng không
                                        sao hết." Lần đầu tiên có người nói như vậy làm tớ khá ngạc nhiên, và, dĩ nhiên,
                                        cảm động.
                                    </span>
                                </div>
                                <div class="exper__content">
                                    <div class="exper__info">
                                        <span class="exper__name">Trần Lê Uyển Nhi - 12A1</span>
